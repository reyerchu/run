...
- 📸 **照片牆** — 上傳賽事照片分享跑步回憶
- ❤️ **收藏賽事** — 一鍵收藏感興趣的賽事
- 📝 **意見反饋** — Dashboard 內提交反饋，通知信自動帶用戶 Email
...
### v0.05 (2026-03-24)
- 賽事社交功能：跑者心得（星星評分 + 文字）、照片牆上傳、收藏賽事
- 意見反饋系統（Dashboard 內，SMTP 通知信自動帶用戶 Email）
- Dashboard sidebar 修正：不再蓋住頂部導航列
- Dashboard 個人檔案頁面對齊修正（靠左與其他頁面一致）
- Sidebar 標題可點擊跳轉 Dashboard、加入副標「記錄您的每一步」
- 全站「你」→「您」統一敬語
- Feedback 頁面套用 RY-UI-skill 設計規範
- Playwright E2E 測試（39 項全通過）
